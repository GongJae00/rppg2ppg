...
Usage:
    python tools/tool_C_cutmix.py --config configs/mamba.toon
    python tools/tool_C_cutmix.py --config configs/lstm.toon --model lstm
"""
...
from utils import apply_cutmix, plot_losses, psnr, compute_pearson
...
def main():
    ...
    # 증강 함수
    augment_fn = partial(apply_cutmix, alpha=STRATEGY["augment_alpha"])
    ...
    print(f"  Augment: CutMix (alpha={STRATEGY['augment_alpha']})")
