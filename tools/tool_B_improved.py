...
Usage:
    python tools/tool_B_improved.py --config configs/mamba.toon
    python tools/tool_B_improved.py --config configs/lstm.toon --model lstm
"""
...
STRATEGY = {
    "augment": None,           # 증강 없음
    "loss": "smoothl1",        # Smooth L1 (Huber) Loss
...
def main():
    ...
    print(f"  Optimizer: AdamW (lr={STRATEGY['lr']}, wd={STRATEGY['weight_decay']})")
    print(f"  Scheduler: CosineAnnealing (T0={STRATEGY['scheduler_T0']}, Tmult={STRATEGY['scheduler_Tmult']})")
    print("-" * 60)
