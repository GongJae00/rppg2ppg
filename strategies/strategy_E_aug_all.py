...
Usage:
    python strategies/strategy_E_aug_all.py --config configs/mamba.toon
    python strategies/strategy_E_aug_all.py --config configs/lstm.toon --model lstm
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run aug_all strategy (Strategy E)")
